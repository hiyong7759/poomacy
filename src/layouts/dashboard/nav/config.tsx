...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    subheader: 'general',
    items: [
      { title: '나의할일', path: PATH_DASHBOARD.general.app, icon: ICONS.dashboard },
    ],
  },
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      // HR
      {
        ...
        icon: ICONS.file,
        children: [
          { title: '인사정보목록', path: PATH_DASHBOARD.HR.list },
          { title: '인사정보등록', path: PATH_DASHBOARD.HR.new },
        ],
      },
      // holidays
      {
      ...
      {
        title: '발령정보',
        path: PATH_DASHBOARD.appoint.root,
        icon: ICONS.folder,
        children: [
