...
export const PATH_DASHBOARD = {
  ...
  appoint: {
    root: path(ROOTS_DASHBOARD, '/appoint'),
    list: path(ROOTS_DASHBOARD, '/appoint/list'),
    new: path(ROOTS_DASHBOARD, '/appoint/new'),
    edit: (name: string) => path(ROOTS_DASHBOARD, `/appoint/${name}/edit`),
  },
  eCommerce: {
